<div class="mx-auto max-w-screen-lg h-screen flex flex-col">
                ...
                <li>
                    <details>
                        ...
                        <ul class="bg-base-100 rounded-t-none p-2">
                            <li><a href="/lockbox/logout">Logout</a></li>
                        </ul>
                    </details>
                </li>
            </ul>
    ...
    <div class="flex space-x-4">
        ...
        <a href="/lockbox/notas/criar" class="btn btn-primary">+ item</a>
    </div>
    ...
    <div class="flex flex-grow py-6">
        ...
        <div class="bg-base-200 rounded-r-box w-full p-10">
            <form action="/lockbox/notas/criar" method="POST" class="flex flex-col space-y-6">
