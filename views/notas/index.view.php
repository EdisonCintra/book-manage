...
<div class="bg-base-300 rounded-l-box w-56 flex flex-col divide-y divide-gray-700 overflow-hidden">
    ...
    <?php foreach($notas as $nota): ?>
        <a href="/lockbox/notas?id=<?=$nota->id?><?= request()->get('pesquisar', '', '&pesquisar=') ?>"
           class="
...
<div class="bg-base-200 rounded-r-box w-full p-10 flex flex-col space-y-6">
    <form action="/lockbox/nota" method="POST" id="form-atualizacao">
    ...
    <div class="flex justify-between items-center">
        <form action="/lockbox/nota" method="POST">
